...
exports.updateNavbarSettings = exports.getNavbarSettings = void 0;
...
const getNavbarSettings = async (req, res) => {
    try {
        const [rows] = await database_1.default.query('SELECT * FROM navbar_settings LIMIT 1');
        const settings = rows;
...
const updateNavbarSettings = async (req, res) => {
    try {
        const { logo_name, about_label, projects_label, skills_label, contact_label, show_about, show_projects, show_skills, show_contact } = req.body;
